...
<template>
	<div
		class="sub-card flex flex-col -mx-4 hover:cursor-pointer hover:bg-slate-100 border-gray-100 border-b"
		@click="handleClick"
	>
		<div class="relative flex flex-row items-center p-4">
			...
			<!-- client avatar -->
			<div
				class="flex items-center justify-center h-10 rounded-full bg-pink-500 text-pink-300 font-bold flex-shrink-0"
			>
